...
const configurationService = {
  ...
  findByConfigurationId(
    ...
    if (parameters["storeId"] === undefined) {
      throw new Error(
        "Request '/store/{storeId}/configuration/{configurationId}' missing path parameter storeId"
      );
    }
    ...
    if (parameters["configurationId"] === undefined) {
      throw new Error(
        "Request '/store/{storeId}/configuration/{configurationId}' missing path parameter configurationId"
      );
    }
