...
const inventoryavailabilityService = {
  ...
  getInventoryAvailabilityByProductId(
    ...
    if (parameters["storeId"] === undefined) {
      throw new Error(
        "Request '/store/{storeId}/inventoryavailability/{productIds}' missing required parameter storeId"
      );
    }
    ...
    if (parameters["productIds"] === undefined) {
      throw new Error(
        "Request '/store/{storeId}/inventoryavailability/{productIds}' missing required parameter productIds"
      );
    }
