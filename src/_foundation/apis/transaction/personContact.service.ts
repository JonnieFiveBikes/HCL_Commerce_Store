...
const personContactService = {
  ...
  getAllPersonContact(
    ...
    if (parameters["storeId"] === undefined) {
      throw new Error(
        "Request '/store/{storeId}/person/@self/contact' missing required parameter storeId"
      );
    }
  ...
  updatePersonContact(
    ...
    if (parameters["storeId"] === undefined) {
      throw new Error(
        "Request '/store/{storeId}/person/@self/contact/{nickName}' missing required parameter storeId"
      );
    }
    ...
    if (parameters["nickName"] === undefined) {
      throw new Error(
        "Request '/store/{storeId}/person/@self/contact/{nickName}' missing required parameter nickName"
      );
    }
