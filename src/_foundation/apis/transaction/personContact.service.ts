...
const personContactService = {
  ...
  getAllPersonContact(parameters: any): AxiosPromise<any> {
    ...
    return contactApiInstance.contactGetAllPersonContact(
      storeId,
      addressType,
      responseFormat,
      options
  ...
  addPersonContact(parameters: any): AxiosPromise<any> {
    ...
    return contactApiInstance.contactAddPersonContact(
      storeId,
      responseFormat,
      body,
      options
  ...
  updatePersonContact(parameters: any): AxiosPromise<any> {
    ...
    return contactApiInstance.contactUpdatePersonContact(
      storeId,
      nickName,
      responseFormat,
      body,
  ...
  deletePersonContact(parameters: any): AxiosPromise<any> {
    ...
    return contactApiInstance.contactDeletePersonContact(
      storeId,
      nickName,
      responseFormat,
      options
