...
const personContactService = {
  ...
  getAllPersonContact(
    ...
    if (parameters["storeId"] === undefined) {
      throw new Error(
        "Request '/store/{storeId}/person/@self/contact' missing path parameter storeId"
      );
    }
  ...
  updatePersonContact(
    ...
    if (parameters["storeId"] === undefined) {
      throw new Error(
        "Request '/store/{storeId}/person/@self/contact/{nickName}' missing path parameter storeId"
      );
    }
    requestUrl = requestUrl.replace("{storeId}", parameters["storeId"]);
    ...
    if (parameters["nickName"] === undefined) {
      throw new Error(
        "Request '/store/{storeId}/person/@self/contact/{nickName}' missing path parameter nickName"
      );
    }
