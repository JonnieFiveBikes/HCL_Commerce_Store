...
const searchDisplayService = {
  ...
  getSearchDisplayView(
    ...
    let path = "/store/{storeId}/searchdisplay/bySearchTerm";
    ...
    if (parameters["storeId"] === undefined) {
      throw new Error(
        "Request '/store/{storeId}/searchdisplay/bySearchTerm' missing required parameter storeId"
      );
    }
    ...
    if (parameters["searchTerm"] !== undefined) {
      ...
      throw new Error(
        "Request '/store/{storeId}/searchdisplay/bySearchTerm' missing required parameter searchTerm"
      );
    }
