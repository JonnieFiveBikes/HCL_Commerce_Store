...
const userActivateService = {
   ...
   */
  activeUser(parameters: any, headers?: any, url?: string): AxiosPromise<any> {
    let site = getSite();
    ...
    let path = "/store/{storeId}/useractivate/emailactivate";
    ...
    if (parameters["storeId"] === undefined) {
      throw new Error(
        "Request '/store/{storeId}/useractivate/emailactivate' missing required parameter storeId"
      );
    }
  ...
  resendActiveUser(
    ...
    let domain = url || siteContext;
    let path = "/store/{storeId}/useractivate/resendemail";
    let requestUrl = domain + path;
    ...
    if (parameters["storeId"] === undefined) {
      throw new Error(
        "Request '/store/{storeId}/useractivate/resendemail' missing required parameter storeId"
      );
    }
