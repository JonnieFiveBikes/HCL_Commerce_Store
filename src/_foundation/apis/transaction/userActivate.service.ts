...
const userActivateApiInstance = new UserActivateApi(
  undefined,
...
const userActivateService = {
  ...
  activeUser(parameters: any): AxiosPromise<any> {
    ...
    return userActivateApiInstance.userActivateActiveUser(
      storeId,
      body,
      responseFormat,
      langId,
  ...
  resendActiveUser(parameters: any): AxiosPromise<any> {
    ...
    return userActivateApiInstance.userActivateResendActiveUser(
      storeId,
      body,
      responseFormat,
      options
