...
const userActivateService = {
  ...
  activeUser(parameters: any, headers?: any, url?: string): AxiosPromise<any> {
    ...
    if (parameters["storeId"] === undefined) {
      throw new Error(
        "Request '/store/{storeId}/useractivate/emailactivate' missing path parameter storeId"
      );
    }
  ...
  resendActiveUser(
    ...
    if (parameters["storeId"] === undefined) {
      throw new Error(
        "Request '/store/{storeId}/useractivate/resendemail' missing path parameter storeId"
      );
    }
    requestUrl = requestUrl.replace("{storeId}", parameters["storeId"]);
