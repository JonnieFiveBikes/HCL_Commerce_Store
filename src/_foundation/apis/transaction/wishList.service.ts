...
const wishListService = {
  ...
  findWishlist(parameters: any): AxiosPromise<any> {
    ...
    return wishlistApiInstance.wishlistFindWishlist(
      storeId,
      responseFormat,
      pageNumber,
      pageSize,
  ...
  createWishlist(parameters: any): AxiosPromise<any> {
    ...
    return wishlistApiInstance.wishlistCreateWishlist(
      storeId,
      responseFormat,
      body,
      options
  ...
  updateWishlist(parameters: any): AxiosPromise<any> {
    ...
    return wishlistApiInstance.wishlistUpdateWishlist(
      storeId,
      externalId,
      responseFormat,
      addItem,
  ...
  deleteWishlist(parameters: any): AxiosPromise<any> {
    ...
    return wishlistApiInstance.wishlistDeleteWishlist(
      storeId,
      externalId,
      responseFormat,
      itemId,
