...
//Custom libraries
import StyledListItem from "../StyledList/StyledListItem";
import StyledListItemIcon from "../StyledList/StyledListItemIcon";
...
const StyledNavigationHeader = styled(({ ...props }) => (
