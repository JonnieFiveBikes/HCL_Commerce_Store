...
function FeaturedProductRecommendationWidget({
  cid,
  widget,
  page,
  renderingContext,
  ...
  const widgetName = getDisplayName(FeaturedProductRecommendationWidget);
  ...
  const FeatureCardLayout = lazy(
    () => import("../widgets/feature-card/FeatureCardLayout")
  );
...
export default FeaturedProductRecommendationWidget;
