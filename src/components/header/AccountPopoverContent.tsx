...
function AccountPopoverContent(props: any): JSX.Element {
  const {
    isB2B,
    userName,
    handleClose,
    ...
    return (
      <>
        <StyledTypography variant="body2" id="header-account-org">
          {t("Header.AccountPopover.Organization")}
        </StyledTypography>
        <StyledTypography
        ...
        <StyledTypography variant="body2" id="header-account-contract">
          {t("Header.AccountPopover.Contract")}
        </StyledTypography>
        <StyledTypography
          ...
          primary={
            <>
              <StyledTypography variant="body2">
                {t("Header.AccountPopover.Welcome", { ...userName })}
              </StyledTypography>
            </>
          }></StyledListItemText>
      </StyledListItem>
  ...
  const AccountSetting = () => {
    return (
      <Link
        ...
        id="head-popover-myaccount_link"
        onClick={handleClose}>
        <StyledListItem>
          <StyledListItemIcon>
            <AccountCircleIcon />
          ...
          <StyledListItemText
            primary={
              <>
                {isB2B
                  ? t("Dashboard.Title")
                  : t("Header.AccountPopover.AccountSetting")}
              </>
            }></StyledListItemText>
        </StyledListItem>
      </Link>
    ...
    return (
      <a href="#" onClick={(event) => handleLogout(event)}>
        <StyledListItem>
          ...
          <StyledListItemText
            primary={
              <>{t("Header.AccountPopover.SignOut")}</>
            }></StyledListItemText>
        </StyledListItem>
      </a>
    );
      ...
      <Link
        ...
        <StyledListItem>
          ...
          <StyledListItemText
            primary={
              <>
                {t("Header.AccountPopover.Cart", { count: Number(cartItems) })}
              </>
            }></StyledListItemText>
        </StyledListItem>
      </Link>
...
AccountPopoverContent.propTypes = {
