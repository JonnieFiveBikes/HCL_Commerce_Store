...
import {
  ...
  withCheckoutProfileContext,
} from "./checkout-profile.context";
    ...
    <StyledContainer cid="create-checkout-profile" spacing={2}>
        ...
        <StyledBreadcrumbs className="vertical-padding-2">
          <StyledLink to={CHECKOUT_PROFILES}>
            <StyledTypography variant="h4">
              {t("CheckoutProfile.TitleCreate")}
            </StyledTypography>
          </StyledLink>
          <span>
            <StyledTypography variant="h4">
              {t("CheckoutProfile.EditProfile")}
            </StyledTypography>
          </span>
        </StyledBreadcrumbs>
      ) : (
      ...
      <StyledGrid container spacing={2}>
        ...
        <StyledGrid
          ...
          {landed ? (
            activeStep === 0 ? (
              <CheckoutProfileShipping />
            ) : (
              <CheckoutProfileBilling />
            )
          ) : null}
        </StyledGrid>
      </StyledGrid>
