...
const CheckoutProfileShipping = (props) => {
  ...
  useEffect(() => {
    ...
    const shippingList = contactList.filter((address) =>
      address.addressType.includes("Shipping")
    );
    ...
    <StyledPaper className="vertical-padding-4">
          ...
          <StyledGrid item xs={12}>
            <StyledFormControl variant="outlined">
              ...
              <StyledSelect
                ...
                onChange={(event) =>
                  setCProf({ ...cProf, shipping_modeId: event.target.value })
                }
                id="ship-methods">
                {modes.map((m) => (
      ...
      <StyledGrid
        ...
        <StyledButton
          ...
          color="primary"
          disabled={
            !nnMap[cProf.shipping_nickName] || !canContinueToBillingInfo()
          }
