...
export const CheckoutProfileContext: React.Context<CheckoutProfileContextType> =
  createContext({} as CheckoutProfileContextType);
...
export const useCheckoutProfileContext = () =>
  useContext(CheckoutProfileContext);
