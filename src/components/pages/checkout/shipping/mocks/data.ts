...
export const initStatesNoAddresses: ShippingTestState = {
  account: {
    ...
    address: {
      ...
      resourceId:
        "https://localhost:443/wcs/resources/store/11/person/@self?langId=-1",
      resourceName: "person",
      userId: "1002",
      orgizationId: "-2000",
    },
  ...
  order: {
    ...
    cart: {
      ...
      channel: {
        ...
        description: {
          language: "-1",
          value:
            "Used when operations performed by a telesales representative.",
        },
      },
      orderStatus: "P",
    ...
    shipInfos: {
      resourceId:
        "https://localhost:443/wcs/resources/store/11/cart/@self/usable_shipping_info?langId=-1",
      orderId: "2831297",
      orderItem: [
        {
          usableShippingMode: [
    ...
    orderItems: [
      {
        ...
        thumbnail:
          "/hclstore/EmeraldCAS//images/catalog/livingroom/furniture/chair3_a1_350.jpg",
        attributes: [
          {
            identifier: "Color",
            usage: "Defining",
