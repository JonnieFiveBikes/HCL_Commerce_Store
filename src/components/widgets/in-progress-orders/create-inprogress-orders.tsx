...
const CreateInprogressOrders: React.FC = () => {
  ...
  return (
    <StyledAccordion>
      <StyledAccordionSummary
        className="horizontal-padding-3 vertical-padding-3"
        ...
        <StyledGrid
          ...
          <StyledGrid item xs={12} sm={3}>
            <StyledTextField
              ...
              helperText={
                !addressUtil.validateNickName(orderName)
                  ? t("InprogressOrders.InvalidOrderName")
                  : EMPTY_STRING
              }
            />
          </StyledGrid>
                ...
                <StyledFormControlLabel
                  ...
                  label={
                    <StyledTypography variant="body2">
                      {t("InprogressOrders.PrivateOrder")}
                    </StyledTypography>
                  }
                />
                <StyledFormControlLabel
                  ...
                  label={
                    <StyledTypography variant="body2">
                      {t("InprogressOrders.SharedOrder")}
                    </StyledTypography>
                  }
                />
              </StyledRadioGroup>
