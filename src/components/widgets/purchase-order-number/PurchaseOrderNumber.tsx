 ...
 * @param props
 */
const PurchaseOrderNumber: React.FC<PurchaseOrderNumberProps> = (
  props: any
) => {
  ...
  const readOnly =
    handlePONumberChange === undefined || isValidPO === undefined;
  ...
  return readOnly ? (
    <>
      <StyledBox
        ...
        <StyledIconLabel
          ...
          label={t("PurchaseOrderNumber.Labels.PONumber")}
        />
        <StyledBox py={1}>
    ...
    <StyledGrid container spacing={2}>
      <StyledGrid
        ...
        <StyledIconLabel
          icon={<DescriptionIcon />}
          label={t("PurchaseOrderNumber.Title")}
        />
      </StyledGrid>
      <StyledGrid item xs={12} sm={4}>
        <StyledTextField
          ...
          helperText={
            !isValidPO() ? t("PurchaseOrderNumber.Msgs.PONumberRequired") : ""
          }
